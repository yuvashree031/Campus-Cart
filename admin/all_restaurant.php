...
<head>
    ...
    <link href="css/minimal-light.css" rel="stylesheet">
</head>
...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
         ...
         <div class="header">
            ...
            <div class="navbar-header">
                    <a class="navbar-brand d-flex align-items-center" href="dashboard.php">
                        <img src="../vit_white.png" alt="homepage" class="dark-logo" style="height:28px;object-fit:contain;" />
                    </a>
                </div>
        ...
        <div class="page-wrapper">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0">All Restaurant</h4>
                            </div>
            ...
            <footer class="footer"> © 2024 - 22MIS0114 22MIS0138 22MIS0122 </footer>
